/** js.std-v1.4.0 LPPL License By https://www.layui.com/admin/ */
        ...
        x = "layui-icon-spread-left", C = "layadmin-side-shrink", k = "LAY-system-side-menu", P = {
            v: "1.4.0 std", req: l.req, exit: l.exit, escape: function (e) {
                ...
                var t, i = e.seconds, n = a(e.elem), l = function (a) {
                    i--, i < 0 ? (n.removeClass(f).html("获取验证�?"), i = e.seconds, clearInterval(t)) : n.addClass(f).html(i + "秒后重获"), a || (t = setInterval(function () {
                        l(!0)
                    }, 1e3))
                };
                e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode), n.on("click", function () {
                    ...
                    if (i === e.seconds && !a(this).hasClass(f)) {
                        if (!/^1\d{10}$/.test(n)) return t.focus(), layer.msg("请输入正确的手机�?");
            ...
            flexible: function (e) {
                ...
                F.note.index = P.popup({
                    ...
                    success: function (e, a) {
                        var i = e.find("textarea"),
                            l = void 0 === t ? "便签中的内容会存储在本地，这样即便你关掉了浏览器，在下次打开时，依然会读取到上一次的记录。是个非常小巧实用的本地备忘�?" : t;
                ...
                a.ajax({
                    type: "get",
                    dataType: "jsonp",
                    data: {name: "js", version: P.v},
                    url: "https://fly.layui.com/api/product_update/",
                    success: function (e) {
                        0 === e.status ? e.version === P.v.replace(/\s|pro|std/g, "") ? layer.alert("当前版本已经是最新版�?") : layer.alert("棢�查到更新，是否前徢�下载�?", {btn: ["更新", "暂不"]}, function (e) {
